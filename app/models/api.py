...
class SummarizeRequest(BaseModel):
    ...
    class Config:
        schema_extra = {
            "example": {
                "text": "FastAPI is a modern, fast (high-performance), web framework for building APIs with Python 3.7+ based on standard Python type hints. The key features are: Fast, Fast to code, Fewer bugs, Intuitive, Easy, Short, Robust, Standards-based.",
                "max_length": 50,
                "min_length": 10
            }
        }
